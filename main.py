...
def BlackJackGame():
    ...
    global playerCardT, dealerCardT, imageCount, BJbool, downCardIndex, totalChips, doubleB
    totalChips = 0
    playerCardT = 0
    dealerCardT = 0
    imageCount = 0
    ...
    def doubleDown():
        ...
        Label(frame_list[globals()['framecount']],
              width=15,
              text='Chips ' + str(player.chipCount()),
    ...
    def dealerBJcheck():
        if dealer.score() == 21:
            ...
            Label(frame_list[globals()['framecount']],
                  ...
                  width=30,
                  font=('JQKAs Wild', 25)).place(x=350, y=400)
            player.loseChips(globals()['bet'] * 2.5)
            Label(frame_list[globals()['framecount']],
                  text='-' + str(globals()['bet'] * 1.5),
                  width=8,
                  fg='red',
